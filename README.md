...
![tag](https://img.shields.io/badge/tag-v1.10.6-brightgreen.svg)
...
> 
> If needed, they can be found inside the full firmware package available on our website `st.com` and downloadable from [here](https://www.st.com/en/embedded-software/stm32cubel1.html#get-software). You will be prompted to login or to register in case you have no account.
