...
This is a typical example on how to use the STM32L1xx USB Device peripheral, where the STM32 MCU is 
enumerated as a HID compliant device using the native PC Host HID driver to which the STM32L152D-EVAL- board
is connected.
...
To test the application, user must proceed as follows:
 ...
 - Select "use SET_FEATURE" or "use SET_REPORT" in order to use SET_REPORT request to send HID Report
   for LED control
 - Use the potentiometer of the STM32L152D-EVAL board to transfer the result of the converted voltage
 ...
 - Select LEDs to switch on/off on the STM32L152D-EVAL board: a SET_REPORT request will be sent
...
@par Directory contents
  ...
  - USB_Device/CustomHID_Standalone/Src/system_stm32l1xx.c      STM32L1xx system clock configuration file
  - USB_Device/CustomHID_Standalone/Src/stm32l1xx_it.c          Interrupt handlers
  - USB_Device/CustomHID_Standalone/Src/stm32l1xx_hal_msp.c     HAL MSP module
  ...
  - USB_Device/CustomHID_Standalone/Inc/stm32l1xx_it.h          Interrupt handlers header file
  - USB_Device/CustomHID_Standalone/Inc/stm32l1xx_hal_conf.h    HAL configuration file
...
@par Hardware and Software environment
  ...
  - STM32L152D-EVAL Set-up
    - Connect the STM32L152D-EVAL board to the PC through 'USB Type A-Male
      to A-Male'.
