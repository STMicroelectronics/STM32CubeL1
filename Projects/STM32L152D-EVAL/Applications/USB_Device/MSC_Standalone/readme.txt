...
This is a typical example on how to use the STM32L1xx USB Device peripheral to communicate with a PC
...
native PC Host MSC driver to which the STM32L152D-EVAL board is connected.
...
@par Directory contents
  ...
  - USB_Device/MSC_Standalone/Src/system_stm32l1xx.c      STM32L1xx system clock configuration file
  - USB_Device/MSC_Standalone/Src/stm32l1xx_it.c          Interrupt handlers
  ...
  - USB_Device/MSC_Standalone/Inc/stm32l1xx_it.h          Interrupt handlers header file
  - USB_Device/MSC_Standalone/Inc/stm32l1xx_hal_conf.h    HAL configuration file
...
@par Hardware and Software environment
  ...
  - STM32L152D-EVAL Set-up
    - Insert a microSD card into the STM32L152D-EVAL uSD slot (CN3)
