/**
  ******************************************************************************
  * @file    TouchSensing/TouchSensing_Linear_swacq/Inc/tsl_conf.h
  * @author  MCD Application Team
  * @brief   TSL configuration file.
...
*/
#define TSLPRM_TKEY_PROX_IN_TH (9)
...
*/
#define TSLPRM_LINROT_CALIB_TH (23)
...
*/
#define TSLPRM_LINROT_DIR_CHG_POS (20)
...
@note for SW acquisition only
*/
#define TSLPRM_USE_GPIOA   (0)
#define TSLPRM_USE_GPIOB   (1)
#define TSLPRM_USE_GPIOC   (0)
#define TSLPRM_USE_GPIOF   (1)
