...
one master and two slaves with different address sizes (7-bit or 10-bit) and 
different maximum speed (400kHz or 100kHz). This example
uses the STM32L1xx I2C HAL and LL API (LL API usage for performance improvement)
and an interrupt.
