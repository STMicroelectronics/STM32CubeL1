...
/* Definitions of environment analog values */
  ...
  #define COMP_WINDOW_THRESHOLD_HIGH       (VREFINT)        /* COMP2 input plus is selected to VrefInt in this example */
  #define COMP_WINDOW_THRESHOLD_LOW        (VREFINT /2)     /* COMP1 input plus is selected to 1/2 VrefInt in this example */
