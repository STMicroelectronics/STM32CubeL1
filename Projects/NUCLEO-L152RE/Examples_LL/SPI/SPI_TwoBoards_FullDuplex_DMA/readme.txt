...
Data buffer transmission and receptionvia $COM_INSTANCE1_TYPE$ using DMA mode. This example is 
based on the STM32L1xx SPI LL API. The peripheral initialization uses 
