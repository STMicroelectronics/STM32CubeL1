...
This is a typical example on how to use the STM32L1xx USB Device peripheral to implement the DFU
capability for programming the embedded flash memory of the STM32L1xx devices.

At the beginning of the main program the HAL_Init() function is called to reset all the peripherals,
initialize the Flash interface and the systick. The user is provided with the SystemClock_Config()
function to configure the system clock (SYSCLK) to run at 32 MHz. The Full Speed (FS) USB module uses
...
@note After each device reset, hold down the Key button on the Nucleo board to enter the DFU mode.
...
@par Directory contents
  ...
  - USB_Device/DFU_Standalone/Inc/stm32l1xx_hal_conf.h    HAL configuration file
  - USB_Device/DFU_Standalone/Inc/stm32l1xx_it.h          IT interrupt handlers header file
  ...
  - USB_Device/DFU_Standalone/Src/stm32l1xx_it.c          IT interrupt handlers
...
@par Hardware and Software environment
  ...
  - This application has been tested with STM32L152RE-Nucleo Rev C board and can be
    easily tailored to any other supported device and development board.

  - STM32L152RE-Nucleo RevC Set-up
	...
	connectors of the STM32L152RE-Nucleo. The USB connector has to be connected to the USB device associated GPIOs
	as follows:
       - DP (D+ of the USB connector) <======> PA12 (Nucleo board) CN10 connector PIN 12
       - DM (D- of the USB connector) <======> PA11 (Nucleo board) CN10 connector PIN 14
...
In order to make the program work, you must do the following :
 ...
 - To run the example, proceed as follows:
   ...
   - Open "DfuSe Demo" and download the "STM32L152xE_NUCLEO_SysTick_0x08007000.dfu"
     provided in Binary directory.
