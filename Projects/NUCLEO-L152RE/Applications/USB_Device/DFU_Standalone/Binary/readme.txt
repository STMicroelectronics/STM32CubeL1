...
This binary is a simple LED toogler. The system Timer (Systick) is used for to generate the delay.
...
@par Hardware and Software environment
  ...
  - This example has been tested with STMicroelectronics STM32L152RE Nucleo
